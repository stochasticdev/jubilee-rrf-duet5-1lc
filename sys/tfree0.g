...
G90                          ; Absolute Mode.
G0 X{-8.5+global.T0XOffset} Y255 F12000         ; Rapid to the back of the post. Stay away from the tool rack so we don't collide with tools.
...
G0 Y{331.5+global.T0YOffset} F6000            ; Controlled move to the park position with tool-1. (park_x, park_y)
M98 P"/macros/tool/tool_unlock.g" ; Unlock the tool
G53 G1 Y255 F6000            ; Retract the pin.
