...
G90                          ; Absolute Mode.
G0 X{64.8+global.T1XOffset} Y255 F12000         ; Rapid to the back of the post. Stay away from the tool rack so we don't collide with tools.
...
G0 Y{331+global.T1YOffset} F6000            ; Controlled move to the park position with tool-1. (park_x, park_y)
